...
func TestFlushRetriesOntoAPeersCommit(t *testing.T) {
	...
	key := "t/metrics/" + bucketindex.Object
	...
	peer.Add(bucketindex.Entry{Prefix: "t/metrics/0000009999", MinTime: 1, MaxTime: 2})
	...
	assert.Contains(t, prefixes, "t/metrics/0000009999", "the peer's part must survive this engine's commit")
	assert.Contains(t, prefixes, "t/metrics/0000000000")
	assert.Contains(t, prefixes, "t/metrics/0000000001")
}
